...
export const CHANGE_CATEGORY_FOR_DIRECTIONS = 'boilerplate/MapPage/CHANGE_CATEGORY_FOR_DIRECTIONS';
export const UPDATE_SEARCH_RESULTS = 'boilerplate/MapPage/UPDATE_SEARCH_RESULTS';
export const START_UPDATE_DIRECTION_RESULTS = 'boilerplate/MapPage/START_UPDATE_DIRECTION_RESULTS';
export const UPDATE_DIRECTION_RESULTS_ERROR = 'boilerplate/MapPage/UPDATE_DIRECTION_RESULTS_ERROR';
