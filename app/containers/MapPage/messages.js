...
export default defineMessages({
  startProjectHeader: {
    id: 'boilerplate.containers.MapPage.start_project.header',
    defaultMessage: 'PadStats'
  },
  startProjectSlogan: {
    id: 'boilerplate.containers.MapPage.start_project.slogan',
    defaultMessage: 'Find a perfect location for your home'
  },
  startProjectMessage: {
    id: 'boilerplate.containers.MapPage.start_project.message',
  ...
  trymeMessage: {
    id: 'boilerplate.containers.MapPage.tryme.message',
    defaultMessage: 'Subscribe to get FREE real estate analytics updates'
  },
  mailChimp: {
    id: 'boilerplate.containers.MapPage.mailChimp',
